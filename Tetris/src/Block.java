...
public class Block {
	...
	public Block() {
		...
		type = BlockType.random();											//Die Blöck werden zufällig erstellt  
		
		
		switch (type) {														//Die Blöcke haben untrschiedliche Farben 
		case I:
			size = 4;
			break;
		case O:
	...
	public void rotate() {
		...
		rotation++;																				//Blöcke können ihre Orientation verändern   
	...
	public int[][][] blockBuilder(BlockType type) throws FileNotFoundException {
		...
		switch (type) {																		//Die Dimensionen der Blöcke werden festgelegt
		case I:
	...
	public int getX() {																//Alle Informationen der Blöcke können ausgelesen und gesetzt werden
		return x;
	}
